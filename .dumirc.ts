...
export default defineConfig({
  favicons: ['https://cdn.jsdelivr.net/gh/youngjuning/cdn@main/favicon/reactflow.ico'],
  autoAlias: false,
  themeConfig: {
    name: 'React Flow',
    logo: 'https://cdn.jsdelivr.net/gh/youngjuning/cdn@main/favicon/reactflow.ico',
